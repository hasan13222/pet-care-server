...
const createCouponIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield coupon_model_1.Coupon.create(newCoupon);
    return result;
});
...
const updateCouponFromDB = (id, updateInfo) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield coupon_model_1.Coupon.findByIdAndUpdate(id, updateInfo);
    return result;
});
